...
package com.qihoo.gamecenter.sdk.demo;

public interface Constants {
	
	public static final String APPNAME = "cannon war";
    /**
     ...
     */
    public static final String APP_SERVER_URL_GET_TOKEN_BY_CODE = "https://openapi.360.cn/oauth2/access_token?grant_type=authorization_code&code=";
    /**
     * 应用服务器为应用客户端提供的接口Url，用于通过AccessToken获取QihooUserInfo
     * (DEMO使用的应用服务器url仅限DEMO示范使用
     * ，禁止正式上线游戏把DEMO应用服务器当做正式应用服务器使用，请使用方自己搭建自己的应用服务器。)
     */
    public static final  String APP_SERVER_URL_GET_USER_BY_TOKEN = "https://openapi.360.cn/user/me.json?access_token=";
}
